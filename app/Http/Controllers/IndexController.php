...
class IndexController extends Controller
{
    ...
    public function weibotrungquoc()
    {
        $loc = Tintuc::where('trangthai', '1')->where('id_category', 14)->orderBy('created_at', 'DESC')->paginate(10);
        $title = 'WEIBO TRUNG QUỐC';
        return view('frontend.pages.loc.loc', compact('loc', 'title'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $s = '(0,36 giây) ';
        return view('frontend.pages.loc.search', compact('url_canonical', 'key', 'tintuc', 'tintuc_t', 'title', 's'));
    }
    ...
    public function danhmuc(Request $request, $slug)
    {
        ...
        return view('frontend.pages.danhmuc.index', compact('url_canonical', 'category', 'title', 'xemnhieunhat', 'tintuc1', 'tintuc2', 'w1', 'c1', 'w2', 'c2', 'w3', 'c3', 'w4', 'w5', 'w6', 'w7', 'w8', 'w9', 'w10', 'w11', 'w12', 'w13', 'w16', 'w17'));
    }
    ...
    public function detail(Request $request, $slug)
    {
        ...
        return view('frontend.pages.detail.index', compact('url_canonical', 'like', 'luachon', 'checkbinhluan', 'binhluan', 'like', 'ketiep', 'slug', 'tin', 'user', 'xuhuong', 'binhluansibar'));
    }
