                            ...
                            <div class="row gutter--15">
                                ...
                                <div class="col-md-12 col-xs-6 col-xxs-12">
                                    ...
                                    <div class="post--item post--layout-1 post--title-large">
                                        <div class="post--img">
                                            <a href="{{ route('bai-viet',['slug'=>$tintuc->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $tintuc->hinhanh }}" alt="" width="281px" height="193px"></a>
                                        ...
                                        <li class="col-md-12">
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="{{ route('bai-viet',['slug'=>$w4->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $w4->hinhanh }}" alt=""></a>
                    ...
                    <ul class="nav row" data-ajax-content="inner">
                        ...
                        <li class="col-md-8">
                            ...
                            <div class="post--item post--layout-1 post--type-video post--title-large">
                                <div class="post--img">
                                    <a href="{{ $w10->video }}" class="thumb"><img src="uploads/tintuc/{{ $w10->hinhanh }}" alt=""></a>
                            ...
                            <ul class="nav">
                                ...
                                <li>
                                    ...
                                    <div class="post--item post--type-audio post--layout-3">
                                        <div class="post--img">
                                            <a href="{{ $tintuc->video }}" class="thumb"><img src="uploads/tintuc/{{ $tintuc->hinhanh }}" alt=""></a>
