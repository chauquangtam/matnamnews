...
@section('title')
<title>{{ $tin->title }}</title>
<meta name="title" content="{{ $tin->title }}" />
<!-- ==== Document Meta ==== -->
<meta name="author" content="">
<meta name="description" content="{{ $tin->tomtat }}">
<meta name="keywords" content="{{ $tin->slug }}">
<!-- ==== Document Meta ==== -->
<meta property="og:title" content="{{ $tin->title }}" />
<meta property="og:description" content="{{ $tin->tomtat }}" />
@endsection
@section('main')
            ...
            <div class="main--content col-md-8" data-sticky-content="true">
                <div class="sticky-content-inner">
                    ...
                    <div class="post--item post--single post--title-largest pd--30-0">
                        <div class="post--img">
                            <a href="#" class="thumb"><img src="{{asset('uploads/tintuc/'.$tin->hinhanh)}}" alt=""></a>
                            @if (Auth::check())
                            <form action="{{ route('like') }}" method="POST">
                                ...
                                <button type="submit" class="icon"><i class="fa fa-heart-o"></i></a>
                                    @else
                                    <button type="submit" class="icon"><i class="fa fa-heartbeat" aria-hidden="true"></i></a>
                                        @endif
                            </form>
                            @else
                    ...
                    <div class="post--nav">
                        <ul class="nav row">
                            ...
                            <li class="col-xs-6 ptop--30 pbottom--30">
                                ...
                                <div class="post--item">
                                    <div class="post--img">
                                        <a href="{{ route('bai-viet',['slug'=>$ketiep->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $ketiep->hinhanh }}" alt=""></a>
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="title">
                                                <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$ketiep->slug]) }}" class="btn-link">{{ $ketiep->title }}</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="nav row" data-ajax-content="inner">
                                ...
                                <li class="col-sm-6 pbottom--30">
                                    ...
                                    <div class="post--item post--layout-1">
                                        <div class="post--img">
                                            <a href="{{ route('bai-viet',['slug'=>$li->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $li->hinhanh }}" alt=""></a>
                                            <a href="{{ url('properti/'.$li->tintucProperti->slug) }}" class="cat">{{ $li->tintucProperti->title }}</a>
                                            ...
                                            <div class="post--info">
                                                ...
                                                <div class="title">
                                                    <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$li->slug]) }}" class="btn-link">{{ $li->title }}</a></h3>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li>
                                ...
                                <div class="comment--item clearfix">
                                    <div class="comment--img float--left">
                                        <img src="{{ asset('frontend/img/news-single-img/comment-avatar-02.jpg') }}" alt="">
                                    </div>
                    ...
                    <div class="comment--form pd--30-0">
                        ...
                        <div class="comment-respond">
                            @if (Auth::check())
                            <form method="POST" action="{{ route('binhluan', ['tin' => $tin->id, 'user' => Auth::user()->id]) }}" data-form="validate">
                                @csrf
                                ...
                                <ul class="nav" data-ajax-content="inner">
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet', ['slug' => $xuhuong->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $xuhuong->hinhanh }}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet', ['slug' => $xuhuong->slug]) }}" class="btn-link">{{ $xuhuong->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="post--items post--items-3">
                                <ul class="nav" data-ajax-content="inner">
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet', ['slug' => $luachon->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $luachon->hinhanh }}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet', ['slug' => $luachon->slug]) }}" class="btn-link">{{ $luachon->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
