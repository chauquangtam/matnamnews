...
<header class="header--section header--style-3">
        ...
        <div class="container">
            <div class="float--left float--xs-none text-xs-center">
                ...
                <ul class="header--topbar-info nav">
                    <li><i class="fa fm fa-map-marker"></i>Đà Nẵng</li>
                    <li><i class="fa fm fa-mixcloud"></i>27<sup>0</sup> C</li>
                    <li><i class="fa fm fa-calendar"></i>Hôm nay ({{ $now }})</li>
                </ul>
            ...
            <div class="float--right float--xs-none text-xs-center">
                ...
                <li><a href="https://www.matnamvn.com/" style="color:yellow" target="_blank">Đọc truyện tranh</a></li>
    ...
    <div class="header--mainbar">
        <div class="container">
            ...
            <!-- Header Ad Start -->
            <!-- <div class="header--ad float--right float--sm-none hidden-xs" width="40%">
                <a href="{{ url('/') }}" class="btn-link">
                    <video autoplay loop muted plays-inline width="60%">
                        <source src="{{asset('frontend/img/matnam.mp4')}}" style="video/mp4">
                    </video>
        ...
        <div class="container">
            ...
            <div id="headerNav" class="navbar-collapse collapse float--left">
                ...
                <ul class="header--menu-links nav navbar-nav" data-trigger="hoverIntent">
                    ...
                    @endforeach
                    <li><a href="https://www.matnamvn.com/" target="_blank">Mật Nấm Truyện</a></li>
                    <li><a href="{{ url('about') }}">Giới thiệu</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Tổng hợp<i class="fa flm fa-angle-down"></i></a>

                        <ul class="dropdown-menu">
                            <li><a href="{{ url('weibotrungquoc') }}">Tin tức Weibo ( Trung Quốc )</a></li>
                            <li><a href="{{ url('tintucmoinhat') }}">Tin tức mới nhất</a></li>
                            <li><a href="{{ url('tinnong') }}">Tin nóng</a></li>
                            <li><a href="{{ url('xemnhieunhat') }}">Xem nhiều nhất</a></li>
