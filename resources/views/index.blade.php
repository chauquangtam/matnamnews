...
@section('title')
<title>Mật Nấm VN - Tin tức mới nhất trong ngày</title>
<meta name="title" content="Mật Nấm VN - Tin tức mới nhất trong ngày" />
<!-- ==== Document Meta ==== -->
<meta name="author" content="">
<meta name="description" content="Trang tin tức cập nhật hot nhất trong ngày" />
<meta name="keywords" content="tintucnhanhvn, tintucnhanhvn.online, tin tuc hom nay, tin tuc 24h" />
<meta property="og:title" content="Tin tức mới nhất trong ngày" />
<meta property="og:description" content="Trang tin tức cập nhật hot nhất trong ngày" />
    ...
    <div class="container">
            ...
            <div class="post--items post--items-1 pd--30-0">
                <div class="row gutter--15">
                        ...
                        <div class="row gutter--15">
                                ...
                                <div class="post--item post--layout-1 post--title-large">
                                    <div class="post--img">
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="title">
                                                <h2 class="h4"><a href="{{ route('bai-viet',['slug'=>$f_f_e->slug]) }}" class="btn-link">{{ $f_f_e->title }}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 hidden-sm hidden-xs">
                                ...
                                <div class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img">
                                        <a href="{{ route('bai-viet',['slug'=>$t_s_f->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $t_s_f->hinhanh }}" style="height:200px" alt=""></a>

                                        <a href="{{ url('category/'.$f_f_e->tintucCategory->slug) }}" class="cat">{{ $t_s_f->tintucCategory->title }}</a>
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="title">
                                                <h2 class="h4"><a href="{{ route('bai-viet',['slug'=>$t_s_f->slug]) }}" class="btn-link">{{ $t_s_f->title }}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="post--item post--layout-1 post--title-larger">
                            <div class="post--img">
                                <a href="{{ route('bai-viet',['slug'=>$e_t_z->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $e_t_z->hinhanh }}" alt=""></a>
                                ...
                                <div class="post--info">
                                    ...
                                    <div class="title">
                                        <h2 class="h4"><a href="{{ route('bai-viet',['slug'=>$e_t_z->slug]) }}" class="btn-link">{{ $e_t_z->title }}</a>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                    ...
                                    <li class="col-xs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$tg->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $tg->hinhanh }}" alt=""></a>

                                                <a href="{{ url('category/'.$tg->tintucCategory->slug) }}" class="cat">{{ $tg->tintucCategory->title }}</a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$tg->slug]) }}" class="btn-link">{{ $tg->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$the_gioi2->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $the_gioi2->hinhanh }}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$the_gioi2->slug]) }}" class="btn-link">{{ $the_gioi2->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="col-xs-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$the_gioi3->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $the_gioi3->hinhanh }}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$the_gioi3->slug]) }}" class="btn-link">{{ $the_gioi3->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="post--items post--items-3" data-ajax-content="outer">
                                <ul class="nav" data-ajax-content="inner">
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$cong_nghe->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $cong_nghe->hinhanh }}" alt=""></a>
                                                <a href="{{ url('category/'.$cong_nghe->tintucCategory->slug) }}" class="cat">{{ $cong_nghe->tintucCategory->title }}</a>
                                                <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$cong_nghe->slug]) }}" class="btn-link">{{ $cong_nghe->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$cong_nghe2->slug]) }}" class="thumb"><img src="uploads/tintuc/{{ $cong_nghe2->hinhanh }}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$cong_nghe2->slug]) }}" class="btn-link">{{ $cong_nghe2->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="col-md-6">
                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                ...
                                                <a href="{{ url('properti/'.$giao_duc->tintucProperti->slug) }}" class="cat">{{ $giao_duc->tintucProperti->title }}</a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$giao_duc->slug]) }}" class="btn-link">{{ $giao_duc->title }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$giao_duc2->slug]) }}" class="btn-link">{{ $giao_duc2->title }}</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$giao_duc3->slug]) }}" class="btn-link">{{ $giao_duc3->title }}</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <ul class="nav row" data-ajax-content="inner">
                    ...
                    <li class="col-md-8">
                        ...
                        <div class="post--item post--layout-1 post--type-video post--title-large">
                            <div class="post--img">
                                <a href="{{ $video->video }}" class="thumb"><img src="uploads/tintuc/{{ $video->hinhanh }}" alt=""></a>
                                ...
                                <div class="post--info">
                                    ...
                                    <div class="title">
                                        <h2 class="h4"><a href="{{ route('bai-viet',['slug'=>$video->slug]) }}" class="btn-link">{{ $video->title }}</a></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="post--item post--type-audio post--layout-3">
                                    <div class="post--img">
                                        ...
                                        <div class="post--info">
                                            ...
                                            <div class="title">
                                                <h3 class="h4"><a href="{{ route('bai-viet',['slug'=>$video->slug]) }}" class="btn-link">{{ $video->title }}</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="ad--space pd--30-0">
            <!-- <a href="https://burine.vn/">
                    <img src="frontend/img/ads-img/970x90_banner_burine.png" alt="" class="center-block">
                </a> -->
        </div>
        <!-- Advertisement End -->
